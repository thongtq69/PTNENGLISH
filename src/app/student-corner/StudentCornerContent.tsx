            ...
            <section className="pt-40 pb-20 bg-accent relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-white text-5xl md:text-7xl font-heading font-semibold mb-6 leading-tight" dangerouslySetInnerHTML={{ __html: hero.title }} />
                        ...
                        {playground.items.filter((i: any) => i.size === 'tiny').map((item: any, idx: number) => (
                            ...
                            >
                                {item.type === 'video' ? (
                                    ...
                                    <img src={item.src} className="w-full h-full object-cover transition-transform group-hover:scale-110" alt="Student Life tiny" />
                                )}
                            </motion.div>
                        ))}
                    </div>
