            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-6">
                    <div className="bg-white rounded-[4rem] p-10 md:p-20 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] border border-slate-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-16">
                        ...
                        <div className="w-full md:w-80 h-[500px] bg-slate-900 rounded-[3rem] relative overflow-hidden shrink-0 shadow-2xl">
                            <img
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-10 pt-16">
                                <div className="mb-10">
                                    <h5 className="text-slate-900 font-heading font-black text-xl mb-4">Mô tả khóa học</h5>
                                    <p className="text-slate-500 leading-relaxed">{selectedLevel.fullDesc}</p>
                                </div>

                                <div>
                                    <h5 className="text-slate-900 font-heading font-black text-lg mb-4 flex items-center gap-2">
                                ...
                                <div className="mt-12 flex gap-4">
                                    <Link href="/contact" className="flex-1 bg-slate-900 text-white py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] text-center hover:bg-black transition-all">
                                        Đăng ký ngay
                                    </Link>
                                    <button
                                        onClick={() => setSelectedLevel(null)}
