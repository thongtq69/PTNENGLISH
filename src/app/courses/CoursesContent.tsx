                        ...
                        >
                            ...
                            <div className="relative pb-8 pt-4 md:pt-10">
                                <div className="relative w-full">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:flex md:flex-row md:justify-between gap-3 sm:gap-4 md:gap-4 relative px-0 md:px-4">
                                        {currentPathway.levels.map((level, i) => (
                                            ...
                                            >
                                                ...
                                                {/* Milestone Node */}
                                                <div className="relative mb-2 md:mb-10 z-10 flex items-center justify-center">
                                                    <div className={`
                                                        w-5 h-5 md:w-[4vw] md:h-[4vw] max-w-[64px] max-h-[64px] rounded-full bg-white border-2 md:border-[0.5vw] lg:border-8 border-slate-200 
                ...
                <div className="container mx-auto px-6 relative z-10 max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        ...
                        <button
                            ...
                            className="bg-white/5 hover:bg-white/10 text-white border border-white/20 backdrop-blur-md px-10 py-5 rounded-full font-bold transition-all uppercase"
                        >
                                ...
                                {schedules.length > 0 ? (
                                    <>
                                        <AnimatePresence mode="wait">
                                            ...
                                            >
                                                <img
                                                    src={schedules[currentScheduleIdx].imageUrl || "https://images.unsplash.com/photo-1506784919141-935049938096?q=80&w=2000&auto=format&fit=crop"}
                                                    alt={schedules[currentScheduleIdx].title}
                                        ...
                                        {schedules.length > 1 && (
                                            <>
                                                <button
                                                    onClick={() => setCurrentScheduleIdx((prev) => (prev - 1 + schedules.length) % schedules.length)}
                                                ...
                                                <button
                                                    onClick={() => setCurrentScheduleIdx((prev) => (prev + 1) % schedules.length)}
                                ...
                                <div className="p-6 md:p-8 w-full bg-white flex flex-col md:flex-row justify-between items-center gap-6">
                                    <div className="text-center md:text-left">
                                        <h4 className="text-2xl font-heading font-black text-accent mb-1">
                                            {schedules[currentScheduleIdx].title}
                                        </h4>
                                        <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm text-slate-500 font-bold">
                                            <span className="flex items-center gap-1.5"><Clock size={16} className="text-primary" /> {schedules[currentScheduleIdx].time}</span>
                                            <span className="flex items-center gap-1.5"><Calendar size={16} className="text-primary" /> {schedules[currentScheduleIdx].date}</span>
                                        </div>
                                    </div>
                                    <Link
                                        href={schedules[currentScheduleIdx].link || "/contact#registration-form"}
