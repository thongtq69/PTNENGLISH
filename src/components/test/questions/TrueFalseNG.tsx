...
/* ════════════════════════════════════════════
   True / False / Not Given  (IELTS type 3)
   Tag: [TFNG1]
   ════════════════════════════════════════════ */
...
const COLORS: Record<string, { active: string; ring: string }> = {
  TRUE: { active: "bg-emerald-500 border-emerald-500 text-white shadow-emerald-200", ring: "ring-emerald-100" },
  FALSE: { active: "bg-red-500 border-red-500 text-white shadow-red-200", ring: "ring-red-100" },
  "NOT GIVEN": { active: "bg-amber-500 border-amber-500 text-white shadow-amber-200", ring: "ring-amber-100" },
};

export const TrueFalseNG = memo(function TrueFalseNG({ qIdx, value, onChange, inputRef }: TrueFalseNGProps) {
  return (
