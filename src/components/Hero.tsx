            ...
            <div className="container mx-auto px-4 relative z-10 text-center py-8 md:py-0">
                <div className="max-w-4xl mx-auto md:pt-24 text-center px-4">
                    ...
                    <div className="flex flex-row justify-center gap-3 md:gap-6 animate-fade-in-up delay-200">
                        ...
                        <Link href={settings.secondaryCTA.link} className="bg-secondary hover:bg-accent text-white px-5 py-3 md:px-10 md:py-5 rounded-full font-heading font-semibold text-xs md:text-lg transition-all transform hover:scale-105 shadow-xl shadow-secondary/30 flex items-center justify-center flex-1 md:flex-none max-w-[160px] md:max-w-none md:min-w-[340px] uppercase" style={{ fontSize: 'var(--fs-home-heroCTA)' }}>
                    ...
                    <div className="flex justify-center mt-3 md:mt-5 animate-fade-in-up delay-300">
                        <button
                            ...
                            className="inline-flex items-center gap-2 bg-secondary hover:bg-accent text-white px-5 py-2.5 md:px-8 md:py-3 rounded-full font-heading font-semibold text-[11px] md:text-sm transition-all shadow-xl shadow-secondary/30 uppercase tracking-wider"
                        >
